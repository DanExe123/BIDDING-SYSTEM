    ...
    <div>
        ...
        <nav class="mt-6 space-y-1 px-4">
            ...
            @role('BAC_Secretary')
                ...
                <a wire:navigate href="{{ route('awarded-items') }}"
                    class="{{ request()->routeIs('awarded-items') ? 'bg-[#EFE8A5] text-black' : 'hover:bg-[#EFE8A5] hover:text-black' }} rounded-full px-4 py-2 flex items-center gap-2">
                    <x-phosphor.icons::regular.users-three class="w-5 h-5" />
                    SKU Management
                </a>
            @endrole
