                                ...
                                <div class="px-6 py-4 space-y-4 text-sm text-gray-700">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="text" wire:model.defer="project_title" placeholder="Project Title" class="w-full border rounded px-3 py-2" />
                                            @error('project_title') <span class="text-red-500">{{ $message }}</span> @enderror
                                        </div>
                                        <div>
                                            <label class="block font-medium mb-1">Project Type*</label>
                                            <input type="text" wire:model.defer="project_type" placeholder="Education, Infrastructure..." class="w-full border rounded px-3 py-2" />
                                        ...
                                        <div wire:poll>
                                            ...
                                            @error('abc') <span class="text-red-500">{{ $message }}</span> @enderror
                                        </div>

                                        <div>
                                            <label class="block font-medium mb-1">Implementing Unit*</label>
                                            <input type="text" wire:model.defer="implementing_unit" placeholder="Office/Department" class="w-full border rounded px-3 py-2" />
                                            @error('implementing_unit') <span class="text-red-500">{{ $message }}</span> @enderror
                                        </div>
                                    </div>
                                    ...
                                    <div wire:poll   class="mt-6">
                                        ...
                                        <table class="w-full table-auto border border-gray-300 text-sm">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="border p-2">
                                                        <input type="text" wire:model.defer="items.{{ $index }}.description" class="w-full border rounded px-2 py-1" />
                                                        @error("items.$index.description") <span class="text-red-500">{{ $message }}</span> @enderror
                                                    </td>
                                                    <td class="border p-2">
                                                        <input type="number" min="1" wire:model.defer="items.{{ $index }}.qty" class="w-full border rounded px-2 py-1" />
                                                    </td>
                                                    <td class="border p-2">
                                                        <input type="text" wire:model.defer="items.{{ $index }}.unit" class="w-full border rounded px-2 py-1" />
                                                    </td>
                                                    <td class="border p-2">
                                                        <input type="number" step="0.01" wire:model.defer="items.{{ $index }}.unitCost" class="w-full border rounded px-2 py-1" />
                                                    </td>
                                                    <td class="border p-2">
                                                        <input type="number" readonly  value="{{ (float)($item['qty'] ?? 0) * (float)($item['unitCost'] ?? 0) }}"  class="w-full border rounded px-2 py-1 bg-gray-100" />
                                                    </td>
                                                    <td class="border p-2 text-center">
                                                        <button type="button" wire:click="removeItem({{ $index }})" class="bg-red-500 text-white px-2 py-1 rounded">X</button>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        ...
                                        <div class="mt-3">
                                            <button type="button" wire:click="addItem" class="bg-green-500 text-white px-4 py-1 rounded hover:bg-green-600">+ Add Item</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="border-dashed border-gray-300 border-2 p-2 rounded-md mt-6">
                                        ...
                                        <input type="file" wire:model="attachment" class="w-full border rounded px-3 py-2" />
