<div class="flex min-h-screen">
    ...
    <div class="border border-gray-300 m-4 rounded-md overflow-hidden">
      ...
      <div class="flex justify-between px-4 py-2 text-sm">
        ...
        <button @click="showModal = true" class="w-1/3 text-center text-blue-600 hover:underline">For Security</button>
    ...
    <div class="bg-gray-100 ml-30 w-[90%] md:w-[800px] rounded-md shadow-lg overflow-hidden" @click.away="showModal = false">
        ...
        <div class="px-6 py-4 flex justify-between items-center border-t border-gray-300">
          ...
          <div class="space-x-2">
            <button class="px-4 py-2 text-sm bg-green-200 text-green-800 rounded hover:bg-green-300">Approve</button>
            <button class="px-4 py-2 text-sm bg-red-300 text-red-800 rounded hover:bg-red-400">Reject</button>
          </div>
        </div>
      </div>
    </div>
