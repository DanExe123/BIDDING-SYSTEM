                        ...
                        @foreach ($users as $user)
                            <tr class="bg-gray-50 border-b">
                                ...
                                <td class="px-4 py-2 border">
                                    <span
                                        class="inline-flex items-center gap-1 bg-blue-200 text-blue-800 px-2 py-1 rounded-full text-xs">
                                ...
                                <td class="px-4 py-2 border space-x-1">
                                    <button
                                        class="bg-blue-100 text-blue-700 px-2 py-1 rounded text-xs">Activate</button>
                                    <button
                                        class="bg-red-100 text-red-700 px-2 py-1 rounded text-xs">Deactivate</button>
                                    <button
                                        class="bg-yellow-100 text-yellow-800 px-2 py-1 rounded text-xs">Archive</button>
